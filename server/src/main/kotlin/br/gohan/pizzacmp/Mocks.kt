...
val messages = flowOf(
    Message("Hello, I am delivering your order", "10:10"),
    Message("Great, thank you! How long will it take?", "10:11"),
    Message("It should be there in about 20 minutes.", "10:12"),
    Message("Perfect, see you soon!", "10:13"),
    Message("Your order has arrived. Enjoy your meal!", "10:30"),
    Message("Thank you! The pizzas look delicious.", "10:31")
)
